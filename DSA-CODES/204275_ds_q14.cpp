...
int main()
{
    ...
    while (1)
    {
        ...
        t1.root = t1.insert(t1.root, node);
    }
    cout << "the tree before deletion : ";
    t1.printInorder(t1.root);
    int val;
    cout << "enter the value to be searched : ";
    int value;
    cin>>value;
    if(t1.iterativeSearch(value))cout<<"element is present"<<endl;
    else cout<<"element is not present"<<endl;
    cout << "enter the value to be deleted : ";
    cin >> val;
    t1.deleteNode(t1.root, val);
    cout << "the tree after deletion of " << val << " : ";
    t1.printInorder(t1.root);
    return 0;
}